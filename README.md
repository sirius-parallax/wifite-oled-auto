...
⚠️ **Замените `/home/ВАШ_ПОЛЬЗОВАТЕЛЬ/` на ваш путь!** (например `/home/arkh/`)
...
> - Тестирования сетей, которыми **вы владеете**
> - Сетей с **письменным разрешением** владельца
> - Образовательных целей в **лабораторной среде**
>
> **Запрещено:**
> - Несанкционированный доступ к чужим сетям
> - Любое коммерческое использование без лицензии
>
> **Ответственность:**
> Авторы не несут ответственности за неправомерное использование данного ПО.
> Несанкционированный доступ запрещён законом (ст. 272-274 УК РФ и аналоги).
>
